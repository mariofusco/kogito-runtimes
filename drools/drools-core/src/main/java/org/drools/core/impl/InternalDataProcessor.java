...
public interface InternalDataProcessor extends DataProcessor {
    ...
    void delete( DataHandle dh, RuleImpl rule, TerminalNode terminalNode, FactHandle.State fhState);
